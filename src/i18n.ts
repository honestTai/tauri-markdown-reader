...
export const uiText = {
  zh: {
    ...
    helpSections: [
      ...
      { title: 'CLI', items: ['安装 GUI 后会随应用安装 md-reader.exe。', '可以在系统终端、Codex 或其他 Agent 中直接调用 md-reader.exe。', 'V4 的 Agent 编排优先走外部 CLI，避免内置终端渲染不稳定。'] },
  ...
  en: {
    ...
    helpSections: [
      ...
      { title: 'CLI', items: ['The GUI installer also ships md-reader.exe with the app.', 'Run md-reader.exe from your system shell, Codex, or other agents.', 'V4 agent orchestration should call the external CLI first instead of relying on an embedded console.'] },
